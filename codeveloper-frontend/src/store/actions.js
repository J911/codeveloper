...
const actions = {
    [types.GET_USER]: function (context) {
        ...
        .catch((e) => context.commit(mutationTypes.SHOW_MESSAGE_BOX, {contents: errorMessages(types.GET_USER,e.response.data.errorCode)}))
    },
    ...
    [types.GET_FILE_LIST]: function (context, payload) {
        ...
        .catch((e) => context.commit(mutationTypes.SHOW_MESSAGE_BOX, {contents: errorMessages(types.GET_FILE_LIST,e.response.data.errorCode)}))
    ...
    [types.GET_FILE]: function (context, payload) {
        ...
        .catch((e) => context.commit(mutationTypes.SHOW_MESSAGE_BOX, {contents: errorMessages(types.GET_FILE,e.response.data.errorCode)}))
    },
    ...
    [types.GET_CONTRIBUTORS](context) {
        ...
        .catch((e) => context.commit(mutationTypes.SHOW_MESSAGE_BOX, {contents: errorMessages(types.GET_CONTRIBUTORS,e.response.data.errorCode)}))
    },
    ...
    [types.ADD_CONTRIBUTOR]: function (context, payload) {
        ...
        .catch((e) => context.commit(mutationTypes.SHOW_MESSAGE_BOX, {contents: errorMessages(types.ADD_CONTRIBUTOR,e.response.data.errorCode)}))
    }
